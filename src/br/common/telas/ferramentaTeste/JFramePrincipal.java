...
public class JFramePrincipal extends javax.swing.JFrame
    ...
    public void addNode(String nodeName) {
        ...
        //Caso contrario, selNode eh um no de suite
            ...
            //nodeFather não é mais o identificador do no com a execução e sim o identificador do grupo de execucao
            ...
            renderCellNodes.getTreeCellRendererComponent(jTree1, nodeFather, rootPaneCheckingEnabled, rootPaneCheckingEnabled, rootPaneCheckingEnabled, nPai, rootPaneCheckingEnabled);
        }

        int index = 0;
        //Obtem em index a posição que o novo no será inserido na árvore. Posição determinada pela ordem alfabética
